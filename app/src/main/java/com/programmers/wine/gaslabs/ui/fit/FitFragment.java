package com.programmers.wine.gaslabs.ui.fit;
                        ...
                        new GoogleApiClient.ConnectionCallbacks() {
                            ...
                            public void onConnectionSuspended(int i) {
                                ...
                                if (i == GoogleApiClient.ConnectionCallbacks.CAUSE_NETWORK_LOST) {
                                    Logger.d("Connection lost.  Cause: Network Lost.");
                                } else if (i == GoogleApiClient.ConnectionCallbacks.CAUSE_SERVICE_DISCONNECTED) {
                                    Logger.d("Connection lost.  Reason: Service Disconnected");
                                }
                            }
                        }
                )
                .addOnConnectionFailedListener(
                        new GoogleApiClient.OnConnectionFailedListener() {
                            ...
                            public void onConnectionFailed(ConnectionResult result) {
                                Logger.d("Connection failed. Cause: " + result.toString());
                                ...
                                if (!authInProgress) {
                                    try {
                                        Logger.d("Attempting to resolve failed connection");
                                        authInProgress = true;
                                        result.startResolutionForResult(getActivity(), REQUEST_OAUTH);
                                    } catch (IntentSender.SendIntentException e) {
                                        Logger.d("Exception while starting resolution activity");
                                    }
                                }
                            }
                        }
                    ...
                    public void onResult(DataSourcesResult dataSourcesResult) {
                        ...
                        for (DataSource dataSource : dataSourcesResult.getDataSources()) {
                            ...
                            if (dataSource.getDataType().equals(DataType.TYPE_LOCATION_SAMPLE) && mListener == null) {
                                Logger.d("Data source for LOCATION_SAMPLE found!  Registering.");
        ...
        Fitness.SensorsApi.add(
                ...
                .setResultCallback(new ResultCallback<Status>() {
                    ...
                    public void onResult(Status status) {
                        if (status.isSuccess()) {
                            Logger.d("Listener registered!");
                        } else {
                            Logger.d("Listener not registered.");
                        }
                    }
                });
